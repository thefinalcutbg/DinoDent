...
void deserializeStatus(Tooth& tooth, Ranges& r, const std::string& code)
{
    ...
    static std::map<std::string, std::function<void(Tooth& tooth, Ranges& r)>> lambdaMap
    {
		...
		{ "DO",	[](Tooth& tooth, Ranges&) mutable { tooth.setStatus(Dental::DefectiveRestoration, true); } },
		{ "DOo",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration,Dental::Surface::Occlusal); } },
		{ "DOm",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Dental::Surface::Medial);  } },
		{ "DOd",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Dental::Surface::Distal);  } },
		{ "DOb",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Dental::Surface::Buccal); } },
		{ "DOl",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Dental::Surface::Lingual);  } },
		{ "DOc",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Dental::Surface::Cervical);  } },
		{ "NC",	[](Tooth& tooth, Ranges&) mutable { tooth.setStatus(Dental::NonCariesLesion, true); } },
		{ "Co",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Dental::Surface::Occlusal); } },
		{ "Cm",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Dental::Surface::Medial);  } },
		{ "Cd",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Dental::Surface::Distal);  } },
		{ "Cb",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Dental::Surface::Buccal); } },
		{ "Cl",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Dental::Surface::Lingual);  } },
		{ "Cc",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Dental::Surface::Cervical);  } },
        ...
        { "N",	[](Tooth& tooth, Ranges&) mutable { tooth.setStatus(Dental::Necrosis, true); } },
        { "Res",[](Tooth& tooth, Ranges&) mutable { tooth.setStatus(Dental::Resorption, true); } },
