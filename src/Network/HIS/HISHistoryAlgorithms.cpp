...
void deserializeStatusCode(Tooth& tooth, Ranges& r, const std::string& code)
{
    static std::map<std::string, std::function<void(Tooth& tooth, Ranges& r)>> lambdaMap
	{
        ...
        { "DR",	[](Tooth& tooth, Ranges&) mutable { tooth.setStatus(Dental::DefectiveRestoration, true); } },
        { "DRo",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration,Surface::Occlusal); } },
        { "DRm",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Surface::Medial);  } },
        { "DRd",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Surface::Distal);  } },
        { "DRb",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Surface::Buccal); } },
        { "DRl",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Surface::Lingual);  } },
        { "DRc",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Surface::Cervical);  } },
		{ "NC",	[](Tooth& tooth, Ranges&) mutable { tooth.setStatus(Dental::NonCariesLesion, true); } },
        { "NCo",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Occlusal); } },
        { "NCm",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Medial);  } },
        { "NCd",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Distal);  } },
        { "NCb",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Buccal); } },
        { "NCl",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Lingual);  } },
        { "NCc",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Cervical);  } },
