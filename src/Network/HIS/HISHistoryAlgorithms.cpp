...
void deserializeStatusCode(Tooth& tooth, Ranges& r, const std::string& code)
{
    static std::map<std::string, std::function<void(Tooth& tooth, Ranges& r)>> lambdaMap
	{
		...
		{ "DOo",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration,Surface::Occlusal); } },
		{ "DOm",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Surface::Medial);  } },
		{ "DOd",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Surface::Distal);  } },
		{ "DOb",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Surface::Buccal); } },
		{ "DOl",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Surface::Lingual);  } },
		{ "DOc",[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::DefectiveRestoration, Surface::Cervical);  } },
		{ "NC",	[](Tooth& tooth, Ranges&) mutable { tooth.setStatus(Dental::NonCariesLesion, true); } },
		{ "Co",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Occlusal); } },
		{ "Cm",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Medial);  } },
		{ "Cd",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Distal);  } },
		{ "Cb",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Buccal); } },
		{ "Cl",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Lingual);  } },
		{ "Cc",	[](Tooth& tooth, Ranges&) mutable { tooth.setSurface(Dental::NonCariesLesion, Surface::Cervical);  } },
